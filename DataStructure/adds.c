...
void main()
{
    int a[20][20],b[20][20],triplet1[10][10],triplet2[20][20],sum[20][20];
    int r1,r2,c1,c2,k=0,q=0,nz=0,i,j;
    printf("enter the 1srt rc\n");
    scanf("%d%d",&r1,&c1);
    ...
    if(r1==r2 && c1==c2)
    {
        ...
        while (i<=k && j<=q)
        {
            ...
            else if (triplet1[i][0]==triplet2[j][0])
            {
                ...
                {
                    nz++;
                    sum[nz][0]=triplet2[i][0];
                    sum[nz][1]=triplet2[i][1];
                    sum[nz][2]=triplet2[i][2];
                    j++;
                }
            }
            else
